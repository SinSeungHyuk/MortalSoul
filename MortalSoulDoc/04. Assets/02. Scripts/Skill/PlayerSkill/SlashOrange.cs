...
namespace MS.Skill
{
    public class SlashOrange : BaseSkill
    {
        ...
        public override async UniTask ActivateSkill(CancellationToken token)
        {
            ...
            var skillObject = SkillObjectManager.Instance.SpawnSkillObject<AreaObject>("Area_SlashOrange", owner, Settings.MonsterLayer);
